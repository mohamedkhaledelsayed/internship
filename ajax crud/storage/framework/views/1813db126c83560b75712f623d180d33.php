                        ...
                        <tbody>
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><img src="<?php echo e($product->image); ?>" width="50" height="50" alt="Image"></td>
                                    <td><?php echo e($product->category->name); ?></td>
                                    <td><button type="button" value="<?php echo e($product->id); ?>" class="btn btn-primary editbtn btn-sm">Edit</button></td>
                                    <td><button type="button" value="<?php echo e($product->id); ?>" class="btn btn-danger deletebtn btn-sm">Delete</button></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<?php /**PATH D:\gamifiercomsa\first task\ajax crud\resources\views/product/products.blade.php ENDPATH**/ ?>